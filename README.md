...
```
gh attestation verify oci://ghcr.io/thesim-net/quorum-api:1.2.0 --repo TheSim-net/Quorum
gh attestation verify oci://ghcr.io/thesim-net/quorum-web:1.2.0 --repo TheSim-net/Quorum
```
