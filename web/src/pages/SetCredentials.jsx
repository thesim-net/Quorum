...
/**
 * One-time "set your admin username and password" step.
 *
 ...
 * password means switching to local-only sign-in can never lock them out.
 *
...
export function SetCredentials({ user }) {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      // A full reload picks up the refreshed /auth/me and lifts the gate.
  ...
  return (
    <div className="shell">
      <div className="card">
        <h1>Set your admin username &amp; password</h1>
        <p className="muted">
